...
setuptools_major_version = int(pkg_resources.get_distribution("setuptools").version.split(".")[0])
...
class bdist_wheel(Command):
    ...
    supported_compressions = OrderedDict([("stored", ZIP_STORED), ("deflated", ZIP_DEFLATED)])
